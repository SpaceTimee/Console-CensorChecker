...
Github Release: [https://github.com/SpaceTimee/Console-CensorChecker/releases](https://github.com/SpaceTimee/Console-CensorChecker/releases)

## 食用方式

1. PowerShell Script: 在 pwsh 7.x 环境中运行 Console-CensorChecker.ps1 脚本 → 按照提示操作即可

2. PowerShell Module: 安装 Console-CensorChecker.psm1 模块 → 执行 Invoke-Check 命令即可
